...
class NewsDetails extends StatelessWidget {
  const NewsDetails({required this.detailsTitle,required this.detailsAuthor,required this.detailsContent,required this.detailsdate,required this.detailsImage, Key? key}) : super(key: key);
  final String detailsImage, detailsTitle, detailsContent, detailsAuthor;
